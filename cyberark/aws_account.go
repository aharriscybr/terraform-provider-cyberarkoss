	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"secrettype": schema.StringAttribute{
				Description: "Required: Secret type of credentials, for AWS Accounts this value must be set to key.",
				Required: true,
			},
			"secret": schema.StringAttribute{
				Description: "Required: Secret Key of the credential object.",
				Required: true,
				Sensitive: true,
			},
			...
			"aws_accountid": schema.StringAttribute{
				Description: "Required: AWS Account ID Number.",
				Required: true,
			},
			"aws_alias": schema.StringAttribute{
				Description: "Optional: AWS Account Alias.",
				Optional: true,
			},
